...
## Introducción
EEl estrés académico constituye una de las principales fuentes de afectación del bienestar físico y emocional en estudiantes universitarios. Situaciones de alta demanda cognitiva, como exámenes o actividades evaluativas, pueden generar respuestas fisiológicas asociadas con la activación del sistema nervioso autónomo, produciendo cambios medibles en diferentes señales biomédicas [1].

Entre las señales fisiológicas más utilizadas para la evaluación objetiva del estrés destacan el electrocardiograma (ECG) y la actividad electrodérmica (EDA). El ECG permite analizar la actividad eléctrica cardíaca mediante parámetros como la frecuencia cardíaca, los intervalos R-R y la variabilidad de la frecuencia cardíaca (HRV), indicadores estrechamente relacionados con la regulación autonómica del organismo [2]. Por otro lado, la EDA mide los cambios en la conductancia eléctrica de la piel producidos por la actividad de las glándulas sudoríparas, siendo considerada uno de los biomarcadores más sensibles para evaluar la activación simpática asociada al estrés [3].

Diversos estudios han demostrado que la combinación de señales ECG y EDA permite caracterizar de manera objetiva y continua las respuestas fisiológicas frente a situaciones de estrés, alcanzando altos niveles de precisión en tareas de clasificación de estados emocionales y cognitivos [4]. Por ello, estas señales representan una alternativa prometedora frente a los métodos tradicionales basados únicamente en cuestionarios subjetivos.

## Problemática a abordar
La evaluación del estrés académico suele realizarse mediante escalas psicológicas, encuestas o cuestionarios de autopercepción que buscan medir el nivel de ansiedad, presión o agotamiento percibido por los estudiantes. Aunque estas herramientas son ampliamente utilizadas debido a su facilidad de aplicación y bajo costo, presentan limitaciones importantes asociadas a la subjetividad de las respuestas. Factores como la percepción individual, el estado emocional del momento, la dificultad para expresar emociones o incluso el deseo de responder de manera socialmente aceptable pueden afectar la precisión de los resultados obtenidos [5].

Además, estos métodos suelen proporcionar únicamente una evaluación puntual del estado emocional del estudiante, sin permitir un seguimiento continuo de los cambios fisiológicos que ocurren durante situaciones de estrés. Esto resulta especialmente relevante en contextos académicos, donde la respuesta al estrés puede variar significativamente antes, durante y después de actividades que demandan un alto esfuerzo cognitivo, como exámenes, exposiciones o tareas complejas. Como consecuencia, existe una brecha entre la percepción subjetiva del estrés y las respuestas fisiológicas reales que experimenta el organismo.

Diversos estudios han demostrado que el estrés académico puede generar alteraciones en el funcionamiento del sistema nervioso autónomo, manifestándose mediante incrementos en la frecuencia cardíaca, disminuciones en la variabilidad de la frecuencia cardíaca y aumentos en la actividad electrodérmica. Sin embargo, estos cambios no siempre son percibidos conscientemente por los estudiantes, lo que dificulta su identificación mediante herramientas basadas únicamente en autoinformes. Esta situación evidencia la necesidad de complementar los métodos tradicionales con técnicas objetivas que permitan evaluar la respuesta fisiológica al estrés de manera más precisa.

En consecuencia, existe la necesidad de incorporar biomarcadores fisiológicos que permitan cuantificar la respuesta autonómica de forma no invasiva y continua. Tanto la variabilidad de la frecuencia cardíaca (HRV), obtenida a partir del ECG, como la actividad electrodérmica (EDA) han demostrado ser indicadores confiables de la activación simpática y del estado de estrés de un individuo [2], [3]. El análisis conjunto de estas señales ofrece una alternativa prometedora para detectar y caracterizar objetivamente los efectos del estrés académico, proporcionando información complementaria a la obtenida mediante cuestionarios psicológicos.

## Propuesta de solución
Se propone desarrollar un protocolo experimental para identificar cambios fisiológicos asociados al estrés académico mediante el registro simultáneo de señales ECG y EDA utilizando el sistema BITalino y el software OpenSignals. A partir de estas señales se analizarán parámetros como la frecuencia cardíaca, los intervalos R-R, la variabilidad de la frecuencia cardíaca y la conductancia de la piel, comparando su comportamiento durante estados de reposo, estrés cognitivo y recuperación.

La hipótesis planteada establece que las situaciones de estrés cognitivo producirán un incremento de la frecuencia cardíaca y de la actividad electrodérmica, acompañado por una disminución de la variabilidad de la frecuencia cardíaca. Estos cambios permitirán diferenciar objetivamente los estados fisiológicos asociados al estrés académico [1], [4].
